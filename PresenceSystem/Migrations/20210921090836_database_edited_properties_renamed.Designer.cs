...
namespace Vacation.Migrations
{
    ...
    [Migration("20210921090836_database_edited_properties_renamed")]
    partial class database_edited_properties_renamed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PresenceSystem.Entities.ListOfPresence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ListOfPresences");
                });

            modelBuilder.Entity("PresenceSystem.Entities.Place", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PresenceSystem.Entities.ListOfPresence", b =>
                {
                    b.HasOne("PresenceSystem.Entities.Place", "Place")
                        .WithMany("ListOfPresences")
                        .HasForeignKey("PlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vacation.Entities.User", "User")
                        .WithMany("ListOfPresences")
