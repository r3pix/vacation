    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<JobTitle,JobTitleModel>()
                .ForMember(x=>x.JobTitleName,m=>m.MapFrom(c=>c.JobTitleName))
                .ForMember(x=>x.Id,m=>m.MapFrom(c=>c.Id));

            CreateMap<EmploymentType, EmploymentTypeModel>()
                .ForMember(x => x.EmploymentTypeName, m => m.MapFrom(c => c.EmploymentTypeName))
                .ForMember(x=>x.Id,m=>m.MapFrom(c=>c.Id));
            ...
            CreateMap<User, UserTableModel>()
                ...
                .ForMember(x => x.DepartmentName, m => m.MapFrom(c => c.Department.DepartmentName))
                .ForMember(x => x.DisplayName, m => m.MapFrom(c => c.DisplayName))
                .ForMember(x => x.Email, m => m.MapFrom(c => c.Email))
                .ForMember(x => x.EmploymentTypeName, m => m.MapFrom(c => c.EmploymentType.EmploymentTypeName))
                .ForMember(x => x.JobTitleName, m => m.MapFrom(c => c.JobTitle.JobTitleName))
            ...
            CreateMap<ListOfPresence, ListOfPresenceTableModel>()
                ...
                .ForMember(x => x.DisplayName, m => m.MapFrom(c => c.User.DisplayName))
                .ForMember(x => x.PlaceName, m => m.MapFrom(c => c.Place.PlaceName))
